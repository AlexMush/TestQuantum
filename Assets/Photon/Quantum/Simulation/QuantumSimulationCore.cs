...
namespace Quantum {
  ...
  public interface ISignalOnPlayerAdded : ISignal {
    ...
    /// <param name="isFirstTime">The first time that this player ref was assigned to a player at all. When firstTime is false the player ref is being reused by a different player. See documentation.</param>
    void OnPlayerAdded(Frame f, PlayerRef player, bool isFirstTime);
  }
