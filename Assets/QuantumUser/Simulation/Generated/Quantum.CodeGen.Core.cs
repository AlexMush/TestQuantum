...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct FinishTrigger : Quantum.IComponent {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Level : Quantum.IComponent {
    public const Int32 SIZE = 4;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
  ...
  public unsafe partial interface ISignalChangeLevel : ISignal {
    void ChangeLevel(Frame f, Int32 levelsCount);
  }
  public unsafe partial interface ISignalResetPlayerPosition : ISignal {
    void ResetPlayerPosition(Frame f, EntityRef playerEntity, PlayerLink* playerLink);
  }
  public static unsafe partial class Constants {
  }
  public unsafe partial class Frame {
    private ISignalChangeLevel[] _ISignalChangeLevelSystems;
    private ISignalResetPlayerPosition[] _ISignalResetPlayerPositionSystems;
    ...
    partial void InitGen() {
      ...
      _ISignalChangeLevelSystems = BuildSignalsArray<ISignalChangeLevel>();
      _ISignalResetPlayerPositionSystems = BuildSignalsArray<ISignalResetPlayerPosition>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.FinishTrigger>();
      BuildSignalsArrayOnComponentRemoved<Quantum.FinishTrigger>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.Level>();
      BuildSignalsArrayOnComponentRemoved<Quantum.Level>();
    ...
    public unsafe partial struct FrameSignals {
      public void ChangeLevel(Int32 levelsCount) {
        var array = _f._ISignalChangeLevelSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.ChangeLevel(_f, levelsCount);
          }
        }
      }
      public void ResetPlayerPosition(EntityRef playerEntity, PlayerLink* playerLink) {
        var array = _f._ISignalResetPlayerPositionSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.ResetPlayerPosition(_f, playerEntity, playerLink);
          }
        }
      }
    }
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.FinishTrigger), Quantum.FinishTrigger.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.Level), Quantum.Level.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 6)
        ...
        .Add<Quantum.FinishTrigger>(Quantum.FinishTrigger.Serialize, null, null, ComponentFlags.None)
        ...
        .Add<Quantum.Level>(Quantum.Level.Serialize, null, null, ComponentFlags.None)
