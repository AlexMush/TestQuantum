...
namespace Quantum.Prototypes {
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.Level))]
  public unsafe partial class LevelPrototype : ComponentPrototype<Quantum.Level> {
    public Int32 CurrentLevel;
    partial void MaterializeUser(Frame frame, ref Quantum.Level result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.Level component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.Level result, in PrototypeMaterializationContext context = default) {
